...
async def signup_admin(
    ...
    try:
        ...
        # TODO: Log - I
        response.status_code = status.HTTP_201_CREATED
        return {"detail": "Admin profile created successfully.", "email": email, "password": password,"status_code": response.status_code}
...
async def signup_user(
    ...
    try:
        ...
        # TODO: Log - I
        response.status_code = status.HTTP_201_CREATED
        return {"detail": "User profile created successfully.", "email": email, "password": password,"status_code": response.status_code}
